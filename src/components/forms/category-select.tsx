...
// export default function CategorySelect({ value, onValueChange, className }: Props) {
//     const [open, setOpen] = useState(false);

//     const { data, isLoading, error, refetch, isFetching } = useFetch<{ categories: string[] }>({
//         endpoint: `${QueryKey.CATEGORIES}`,
//         queryKey: [QueryKey.CATEGORIES, QueryKey.OPTIONS],
//         options: {
//             enabled: !!countryId,
//         }
//     });
