...
export const LearningResourceSinglePage = ({ resource }: Props) => {
    const backLink = resource.parent?.id ? `/super_admin/learning-resources/${resource.parent.id}` : "/super_admin/learning-resources";
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {resource.children.map((child) => (
                                    <Link
                                        key={child.id}
                                        href={`/super_admin/learning-resources/${resource.id}/${child.id}`}
